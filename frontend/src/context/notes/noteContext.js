...
// Create a Context:
// First, you create a context using React.createContext. This function returns an object with two components: Provider and Consumer (prior to React 16.8, the Consumer component was used to consume context, but now we can use the useContext hook).
